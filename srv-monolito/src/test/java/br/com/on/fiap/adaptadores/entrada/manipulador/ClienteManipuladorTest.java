...
class ClienteManipuladorTest {
    ...
    void dadoClienteExistente_quandoBuscarCliente_entaoDeveSerRetornado() {
        ...
        br.com.on.fiap.hexagono.interfaceadapters.interfaces.dto.ClienteRespostaDTO clienteRespostaDTO =
                DataPoolClienteRespostaDTO.gerarCliente();
        when(clienteControlador.buscaClientePorCpf(cpf)).thenReturn(clienteRespostaDTO);
        ResponseEntity<br.com.on.fiap.hexagono.interfaceadapters.interfaces.dto.ClienteRespostaDTO> response =
                clienteManipulador.buscaClientePorCpf(cpf);
