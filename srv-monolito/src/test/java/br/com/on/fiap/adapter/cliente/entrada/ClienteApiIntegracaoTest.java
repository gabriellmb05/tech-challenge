package br.com.on.fiap.adapter.cliente.entrada;
...
class ClienteApiIntegracaoTest {
    ...
    @Order(1)
    @DisplayName(
            "Dado um cliente novo, quando nao informar o nome do cliente, então deve retornar erro de validação 'O atributo nome é obrigatório'")
    ...
    @Order(2)
    @DisplayName(
            "Dado um cliente novo, quando nao informar o cpf do cliente, então deve retornar erro de validação 'O atributo cpf é obrigatório'")
    void dadoClienteNovo_quandoInserirClienteSemInformarCpf_entaoDeveRetornarErroDeValidacao() throws Exception {
        mockMvc.perform(post("/clientes")
                ...
                .andExpect(status().isBadRequest())
                .andExpect(jsonPath("$.errors[0]").value("O atributo cpf é obrigatório"))
                .andReturn();
    }
    ...
    @Order(3)
    @DisplayName(
            "Dado um cliente novo, quando nao informar o email do cliente, então deve retornar erro de validação 'O atributo email é obrigatório'")
    void dadoClienteNovo_quandoInserirClienteSemInformarEmail_entaoDeveRetornarErroDeValidacao() throws Exception {
        mockMvc.perform(post("/clientes")
                ...
                .andExpect(status().isBadRequest())
                .andExpect(jsonPath("$.errors[0]").value("O atributo email é obrigatório"))
                .andReturn();
    }
    ...
    @Order(4)
    @DisplayName(
            "Dado um cliente novo, quando inserir o cliente com CPF inválido, então deve retornar erro de validação 'O CPF informado é inválido'")
    void dadoClienteNovo_quandoInserirClienteComCpfInvalido_entaoDeveRetornarErroDeValidacao() throws Exception {
        mockMvc.perform(post("/clientes")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(
                                DataPoolClienteSolicitacaoDTO.gerarComCpf("12312312312"))))
                .andExpect(status().isBadRequest())
    ...
    @Order(5)
    @DisplayName(
            "Dado um cliente novo, quando inserir o cliente com E-mail inválido, então deve retornar erro de validação 'O E-mail informado é inválido'")
    void dadoClienteNovo_quandoInserirClienteComEmailInvalido_entaoDeveRetornarErroDeValidacao() throws Exception {
        mockMvc.perform(post("/clientes")
                ...
                .andExpect(status().isBadRequest())
                .andExpect(jsonPath("$.errors[0]").value("O E-mail informado é inválido"))
                .andReturn();
    }
    ...
    void dadoClienteCriado_quandoBuscarClientePorCpf_entaoDeveRetornarOCliente() throws Exception {
        mockMvc.perform(get("/clientes/{cpf}", "10903153092"))
    ...
    @Order(8)
    @DisplayName(
            "Dado um cliente criado, quando buscar o cliente com cpf diferente do cadastrado, então deve retornar erro de validação 'Não foi encontrado Cliente para o cpf: {valor}'")
    ...
    @Order(9)
    @DisplayName(
            "Dado um cliente novo, quando inserir o cliente com cpf já existente, então deve retornar erro de validação 'O CPF de número {valor} já foi utilizado'")
    ...
    @Order(10)
    @DisplayName(
            "Dado um cliente novo, quando inserir o cliente com E-mail já existente, então deve retornar erro de validação 'O E-mail {valor} já foi utilizado'")
    void dadoClienteNovo_quandoInserirClienteComEmailJaCadastrado_entaoDeveRetornarErroDeValidacao() throws Exception {
        mockMvc.perform(post("/clientes")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(
                                DataPoolClienteSolicitacaoDTO.gerarComEmail("teste@gmail.com"))))
                .andExpect(status().isBadRequest())
                .andExpect(jsonPath("$.errors[0]").value("O E-mail teste@gmail.com já foi utilizado"))
                .andReturn();
    }
}
