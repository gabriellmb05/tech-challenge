...
public class ManipuladorExcecaoGlobal {
    ...
    public ResponseEntity<DetalhesErrosGerais> handleApplicationExcecaoPadrao(
            ExcecaoPadraoAplicacao ex, WebRequest request) {
        return ResponseEntity.badRequest()
                .body(DetalhesErrosGerais.builder()
    ...
    public ResponseEntity<DetalhesErrosGerais> handleValidationExceptions(
    ...
    public ResponseEntity<DetalhesErrosGerais> handleCategoriaNaoEncontradaExcecao(
    ...
    public ResponseEntity<DetalhesErrosGerais> handleProdutoExistenteExcecao(
    ...
    public ResponseEntity<DetalhesErrosGerais> handleClienteExistenteExcecao(
    ...
    public ResponseEntity<DetalhesErrosGerais> handleProdutoNaoEncontradoExcecao(
            ProdutoNaoEncontradoExcecao ex, WebRequest request) {
        return new ResponseEntity<>(
                DetalhesErrosGerais.builder()
    ...
    public ResponseEntity<DetalhesErrosGerais> handleClienteNaoEncontradoExcecao(
