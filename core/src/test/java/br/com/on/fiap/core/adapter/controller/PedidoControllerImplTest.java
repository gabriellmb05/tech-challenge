...
import br.com.on.fiap.core.application.dto.resposta.ProdutoQuantidade;
...
import br.com.on.fiap.datapool.PedidoFiltroEntradaDataPool;
import br.com.on.fiap.datapool.PedidoProdutoDataPool;
    ...
    void dadoProtocolo_quandoDetalharPedido_entaoDeveRetornarPedidoDetalhadoFormatado() {
        ...
        PedidoDetalhadoResposta pedidoDetalhadoResposta = PedidoDetalhadoResposta.create(
                ...
                Collections.singletonList(
                        ProdutoQuantidade.create(PedidoProdutoDataPool.criarPedidoProdutoComProduto(1L))),
