...
public class ClienteControladorIntegracaoTest {
	...
	void dadoClienteNovo_quandoInserirClienteSemInformarCpf_entaoDeveRetornarErroDeValidacao() throws Exception {
		mockMvc.perform(post("/clientes").contentType(MediaType.APPLICATION_JSON)
				.content(objectMapper.writeValueAsString(DataPoolClienteSolicitacaoDTO.gerarComCpf(null)))).andExpect(status().isBadRequest())
	...
	void dadoClienteNovo_quandoInserirClienteSemInformarEmail_entaoDeveRetornarErroDeValidacao() throws Exception {
		mockMvc.perform(post("/clientes").contentType(MediaType.APPLICATION_JSON)
				.content(objectMapper.writeValueAsString(DataPoolClienteSolicitacaoDTO.gerarComEmail(null)))).andExpect(status().isBadRequest())
	...
	void dadoClienteNovo_quandoInserirClienteComCpfInvalido_entaoDeveRetornarErroDeValidacao() throws Exception {
        mockMvc.perform(post("/clientes").contentType(MediaType.APPLICATION_JSON)
				.content(objectMapper.writeValueAsString(DataPoolClienteSolicitacaoDTO.gerarComCpf("12312312312")))).andExpect(status().isBadRequest())
	...
	void dadoClienteNovo_quandoInserirClienteComEmailInvalido_entaoDeveRetornarErroDeValidacao() throws Exception {
        mockMvc.perform(post("/clientes").contentType(MediaType.APPLICATION_JSON)
				.content(objectMapper.writeValueAsString(DataPoolClienteSolicitacaoDTO.gerarComEmail("teste")))).andExpect(status().isBadRequest())
	...
	void dadoClienteNovo_quandoInserirCliente_entaoDeveSerSalvo() throws Exception {
        mockMvc.perform(post("/clientes").contentType(MediaType.APPLICATION_JSON)
				.content(objectMapper.writeValueAsString(DataPoolClienteSolicitacaoDTO.gerarComCpfEmail("10903153092", "teste@gmail.com")))).andExpect(status().isCreated())
				.andReturn();
	}
	...
	void dadoClienteNovo_quandoInserirClienteComCpfJaCadastrado_entaoDeveRetornarErroDeValidacao() throws Exception {
        mockMvc.perform(post("/clientes").contentType(MediaType.APPLICATION_JSON)
				.content(objectMapper.writeValueAsString(DataPoolClienteSolicitacaoDTO.gerarComCpf("10903153092")))).andExpect(status().isBadRequest())
	...
	void dadoClienteNovo_quandoInserirClienteComEmailJaCadastrado_entaoDeveRetornarErroDeValidacao() throws Exception {
		mockMvc.perform(post("/clientes").contentType(MediaType.APPLICATION_JSON)
				.content(objectMapper.writeValueAsString(DataPoolClienteSolicitacaoDTO.gerarComEmail("teste@gmail.com")))).andExpect(status().isBadRequest())
