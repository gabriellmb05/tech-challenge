...
public class ClienteControladorIntegracaoTest {
    ...
    private static ClienteSolicitacaoDTO clienteSolicitacaoDTO;
    ...
    void dadoClienteNovo_quandoInserirClienteSemInformarNome_entaoDeveRetornarErroDeValidacao() throws Exception {
        ClienteSolicitacaoDTO clienteSolicitacaoDTO =  ClienteSolicitacaoDTO.builder()
                .nome(null)
                .cpf("10903153092")
        ...
        mockMvc.perform(post("/clientes")
                        ...
                        .content(objectMapper.writeValueAsString(clienteSolicitacaoDTO)))
