package br.com.on.fiap.hexagono.interfaceadapters.interfaces.dto;
...
public class ClienteRespostaDTO {
    ...
    public ClienteRespostaDTO(Long id, String nome, String cpf, String email, LocalDate dataNascimento) {
        this.id = id;
        this.nome = nome;
        this.cpf = cpf;
        this.email = email;
    ...
    public boolean equals(Object obj) {
        ...
        var that = (ClienteRespostaDTO) obj;
