...
class InsereClienteCasoDeUsoImplTest {

    @Mock
    private ClienteGateway clienteGateway;

    @InjectMocks
    private InsereClienteCasoDeUsoImpl insereClienteCasoDeUsoImpl;
    ...
    void dadoClienteValido_quandoInserirCliente_entaoClienteDeveSerSalvo() {
        ...
        ClienteSaidaDTO clienteSaidaDTO = insereClienteCasoDeUsoImpl.inserir(clienteEntradaDTO);
    ...
    void dadoClienteComCpfExistente_quandoInserirCliente_entaoDeveLancarExcecao() {
        ...
        ClienteExistenteExcecao exception = assertThrows(
                ClienteExistenteExcecao.class, () -> insereClienteCasoDeUsoImpl.inserir(clienteEntradaDTO));
    ...
    void dadoClienteComEmailExistente_quandoInserirCliente_entaoDeveLancarExcecao() {
        ...
        ClienteExistenteExcecao exception = assertThrows(ClienteExistenteExcecao.class, () -> {
            insereClienteCasoDeUsoImpl.inserir(clienteEntradaDTO);
        });
