...
import br.com.on.fiap.casosdeuso.AlteraProdutoCasoDeUso;
...
class AlteraProdutoCasoDeUsoTest {
  ...
  @InjectMocks private AlteraProdutoCasoDeUso alteraProdutoCasoDeUso;
  ...
  void dadoProdutoNaoExistente_quandoAlterarProduto_entaoDeveLancarExcecao() {
    ...
    assertThrows(
        ProdutoNaoEncontratoExcecao.class, () -> alteraProdutoCasoDeUso.alterar(id, produto));
