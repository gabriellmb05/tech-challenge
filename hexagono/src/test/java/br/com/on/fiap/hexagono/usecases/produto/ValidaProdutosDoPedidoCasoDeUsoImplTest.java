...
import br.com.on.fiap.hexagono.usecases.casodeuso.produto.ValidaProdutosDoPedidoCasoDeUsoImpl;
...
class ValidaProdutosDoPedidoCasoDeUsoImplTest {

    @Mock
    private PersisteProdutoPortaSaida persisteProdutoPortaSaida;

    @InjectMocks
    private ValidaProdutosDoPedidoCasoDeUsoImpl validaProdutosDoPedidoCasoDeUsoImpl;
