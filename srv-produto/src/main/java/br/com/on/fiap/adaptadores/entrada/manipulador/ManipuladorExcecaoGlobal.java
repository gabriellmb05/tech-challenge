...
public class ManipuladorExcecaoGlobal extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ProblemDetail> manipulaProdutoExistenteExcecao(ProdutoExistenteExcecao ex, WebRequest request) {
    ...
    public ResponseEntity<ProblemDetail> manipulaProdutoNaoEncontradoExcecao(ProdutoNaoEncontratoExcecao ex, WebRequest request) {
    ...
    public ResponseEntity<ProblemDetail> manipulaCategoriaNaoEncontradaExcecao(CategoriaNaoEncontradaExcecao ex, WebRequest request) {
        return createResponseEntity(ex, HttpStatus.BAD_REQUEST, ex.getMessage(), request);
    }
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex, HttpHeaders headers, HttpStatusCode status, WebRequest request) {
        ...
        ProblemDetail detalheProblema = ProblemDetail.forStatusAndDetail(status, "Erro de validação referente a entrada dos dados");
        detalheProblema.setProperty("errors", errors);
        return new ResponseEntity<>(detalheProblema, headers, status);
    }

    private ResponseEntity<ProblemDetail> createResponseEntity(Exception ex, HttpStatus status, String message, WebRequest request) {
