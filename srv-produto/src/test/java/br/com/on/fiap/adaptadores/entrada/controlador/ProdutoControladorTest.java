...
class ProdutoControladorTest {
  ...
  static Stream<Arguments> produtoDTOProvider() {
    return Stream.of(
        Arguments.of(
            new ProdutoRespostaDTO(1L, "Produto 1", "Descricao 1", BigDecimal.valueOf(10.0)),
            new ProdutoSolicitacaoDTO("Produto 1", "Descricao 1", BigDecimal.valueOf(10.0))),
        Arguments.of(
            new ProdutoRespostaDTO(2L, "Produto 2", "Descricao 2", BigDecimal.valueOf(20.0)),
            new ProdutoSolicitacaoDTO("Produto 2", "Descricao 2", BigDecimal.valueOf(20.0))),
        Arguments.of(
            new ProdutoRespostaDTO(3L, "Produto 3", "Descricao 3", BigDecimal.valueOf(30.0)),
  ...
  void dadoProdutoNovo_quandoInserirProduto_entaoDeveSerSalvo(
    ...
    ResponseEntity<ProdutoRespostaDTO> response =
        produtoControlador.insereProduto(produtoSolicitacaoDTO);
  ...
  void dadoProdutoExistente_quandoAlterarProduto_entaoDeveSerAtualizado(
    ...
    ResponseEntity<ProdutoRespostaDTO> response =
        produtoControlador.alteraProduto(id, produtoSolicitacaoDTO);
